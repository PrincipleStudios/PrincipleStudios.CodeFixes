...
// from https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/74591294646621a7c77b0b8bfa8bbb5b694ca660/StyleCop.Analyzers/StyleCopTester/CodeFixEquivalenceGroup.cs
...
internal sealed class TesterDiagnosticProvider : FixAllContext.DiagnosticProvider
{
    ...
    public override Task<IEnumerable<Diagnostic>> GetDocumentDiagnosticsAsync(Document document, CancellationToken cancellationToken)
    {
        ...
        if (document.FilePath == null || !projectDocumentDiagnostics.TryGetValue(document.FilePath, out diagnostics))
        {
            return Task.FromResult(Enumerable.Empty<Diagnostic>());
        }
